...
<div class="frame group">
	...
	<?php
		$show_id = $_GET['id'];
		$result = mysql_query("SELECT * FROM trivia WHERE (show_id = $show_id)");
		...
		" | <a href=\"trailer.php?id=" . $show_id . "\">Watch Trailer</a>" . 
		...
		echo "| <a name=\"fb_share\" share_url=\"localhost/trivia.php?id=".$show_id."\">Share</a>";
		?>
		</p>
	</div>
