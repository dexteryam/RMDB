...
require_once FORUM_ROOT.'lang/'.$forum_user['language'].'/admin_common.php';
require_once FORUM_ROOT.'lang/'.$forum_user['language'].'/admin_users.php';
require_once FORUM_ROOT.'lang/'.$forum_user['language'].'/admin_bans.php';
...
else if (isset($_GET['show_users']))
{
	...
	require_once FORUM_ROOT.'lang/'.$forum_user['language'].'/misc.php';
